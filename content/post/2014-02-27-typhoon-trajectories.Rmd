...
National Climatic Data Center에서 제공하는 [NCDC International Best Track Archive for Climate Stewardship (IBTrACS) Project, Version 3](https://data.nodc.noaa.gov/cgi-bin/iso?id=gov.noaa.ncdc:C00834)을 이용했다. 다양한 포맷의 데이터를 제공하는데 여기서는 csv 파일을 이용.  
...
> 구글아 구글아 동해를 내놓아라 내어놓지 않으면 구워서 먹으리.
